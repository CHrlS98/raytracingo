...
void Scene::SetupLights()
{
    ...
    SurfaceLight light0 = SurfaceLight(PRIMITIVE_TYPE::RECTANGLE, sl0ModelMatrix, { 1.0, 1.0, 1.0 }, 0.0001f);
    m_surfaceLights.push_back(light0);

    //sutil::Matrix4x4 sl1ModelMatrix = GetTranslate(0.0f, 4.99f, 0.0f) * GetRotate(M_PIf, 1.0f, 0.0f, 0.0f) * GetScale(5.0f, 1.0, 0.2f);
    //SurfaceLight light1 = SurfaceLight(PRIMITIVE_TYPE::RECTANGLE, sl1ModelMatrix, { 0.7, 0.7, 0.7 }, 0.7f);
