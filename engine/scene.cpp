...
void Scene::SetupObjects()
{
    ...
    m_shapes.push_back(std::make_shared<Plane>(Plane(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f))));
}
...
void Scene::SetupLights()
{
    ...
    m_lights.push_back(PointLight({ 10.0, 10.0, 10.0 }, { 0.6, 0.6, 0.6 }));
